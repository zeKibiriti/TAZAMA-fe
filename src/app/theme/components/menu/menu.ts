...
export const verticalMenuItems = [
    ...
    new Menu (2, 'Settings', '/settings', null, 'settings', null, true, 0),
    new Menu (3, 'Stations', '/stations', null, 'computer', null, false, 2),
    new Menu (4, 'Station Status', '/station-status', null, 'data_usage', null, false, 2),
    new Menu (5, 'Users Management', '/users-management', null, 'supervisor_account', null, true, 0),
    new Menu (6, 'Users', '/users', null, 'card_membership', null, false, 5),
    new Menu (7, 'Roles', '/roles', null, 'dns', null, false, 5),
    new Menu (8, 'Permissions', '/permissions', null, 'grid_on', null, false, 5),
