...
export const verticalMenuItems = [
    ...
    new Menu (2, 'Station Logs', '/station-logs', null, 'settings', null, false, 0),
    new Menu (3, 'Settings', '/settings', null, 'settings', null, true, 0),
    new Menu (4, 'Stations', '/stations', null, 'computer', null, false, 3),
    new Menu (5, 'Station Status', '/station-status', null, 'data_usage', null, false, 3),
    new Menu (6, 'Users Management', '/users-management', null, 'supervisor_account', null, true, 0),
    new Menu (7, 'Users', '/users', null, 'card_membership', null, false, 6),
    new Menu (8, 'Roles', '/roles', null, 'dns', null, false, 6),
    new Menu (9, 'Permissions', '/permissions', null, 'grid_on', null, false, 6),
